...
export interface ApiEvenementEvenement extends Schema.CollectionType {
  ...
  attributes: {
    ...
    descriptionFR: Attribute.Text;
    descriptionIT: Attribute.Text;
    nbPlace: Attribute.Integer &
      Attribute.SetMinMax<{
        min: 1;
      }>;
    image: Attribute.Media & Attribute.Required;
    presentateur: Attribute.Relation<
...
export interface ApiMembreMembre extends Schema.CollectionType {
  ...
  attributes: {
    ...
    estAdmin: Attribute.Boolean & Attribute.Required;
    profession: Attribute.String;
    adresse: Attribute.String;
    telPortable: Attribute.String &
      Attribute.SetMinMaxLength<{
        minLength: 10;
        maxLength: 10;
      }>;
    telFixe: Attribute.String &
      Attribute.SetMinMaxLength<{
        minLength: 10;
        maxLength: 10;
      }>;
    email: Attribute.Email;
    motDePasse: Attribute.Password &
      Attribute.Private &
      Attribute.SetMinMaxLength<{
        minLength: 1;
      }>;
    dateNaissance: Attribute.Date;
    trancheAge: Attribute.Enumeration<
      [
        'e < 30',
        'e 30-40',
        'e 40-50',
